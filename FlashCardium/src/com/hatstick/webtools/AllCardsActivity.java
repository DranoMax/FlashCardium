...
public class AllCardsActivity extends ListActivity {
    ...
    private static String url_all_cards = "http://localhost/getall.php";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllCardsActivity.this);
